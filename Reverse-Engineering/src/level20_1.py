...
context.binary = elf = ELF("/challenge/babyrev_level20.1", checksec=False)
...
def interpret_cmp(a1, a2_hex_arr):
    ...
    for i in range(902, 923):
        license_key[i - 902] = a1_arr[i]
...
value_add = [0x39, 0xf8, 0xe1, 0x75, 0x32, 0x91, 0xe8, 0x22, 0x22, 0x8a, 0xdc, 0xaa, 0x83, 0xb7, 0x67, 0x83, 0xad, 0x8d, 0xf6, 0x06, 0xba]
