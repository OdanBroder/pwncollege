...
context.binary = elf = ELF("/challenge/babyrev_level18.0", checksec=False)
...
interpret_imm(a1, 4, 96)
interpret_imm(a1, 1, 9)
interpret_imm(a1, 32, 0)
interpret_sys(a1, 2, 32)
interpret_imm(a1, 4, 128)
interpret_imm(a1, 1, 1)
interpret_imm(a1, 32, 65)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 87)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 208)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 192)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 159)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 211)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 236)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 57)
interpret_stm(a1, 4, 32)
interpret_add(a1, 4, 1)
interpret_imm(a1, 32, 65)
interpret_stm(a1, 4, 32)
