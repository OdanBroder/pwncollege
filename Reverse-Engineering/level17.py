...
context.binary = elf = ELF("/challenge/babyrev_level17.0", checksec=False)
...
interpret_imm(a1, 4, 112)
interpret_imm(a1, 64, 9)
interpret_imm(a1, 16, 0)
interpret_sys(a1, 1, 16)
interpret_imm(a1, 4, 144)
interpret_imm(a1, 64, 1)
interpret_imm(a1, 16, 13)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 102)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 237)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 170)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 35)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 217)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 99)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 67)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 16, 90)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_imm(a1, 4, 144)
interpret_imm(a1, 64, 1)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 217)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
...
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 195)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 218)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 15)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 198)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 112)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 6)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
interpret_ldm(a1, 16, 4)
interpret_imm(a1, 32, 145)
interpret_add(a1, 16, 32)
interpret_stm(a1, 4, 16)
interpret_add(a1, 4, 64)
